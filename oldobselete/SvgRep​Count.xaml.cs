...
namespace SvgComposition.AttributeControls.ComboAttrib
{
    /// <summary>
    /// Interaction logic for SvgRep​Count.xaml
    /// </summary>
    public partial class SvgRepCount : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgRep​Count), new FrameworkPropertyMetadata("none",
