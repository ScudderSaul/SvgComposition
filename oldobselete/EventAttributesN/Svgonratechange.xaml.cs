...
namespace SvgComposition.AttributeControls.EventAttributes
{
     ...
     public partial class Svgonratechange : UserControl, ISvgAttributeControl, INotifyPropertyChanged
     {
  
     private string _labelText;
     private string _svgAttributeLocalValue = " ";
  
       public Svgonratechange()
       {
          InitializeComponent();
          DataContext = this;
          LabelText = "onratechange";
       }
  
        public static readonly DependencyProperty IsLabelTextProperty =  
            DependencyProperty.Register("IsLabelText", typeof(string), typeof(Svgonratechange),   
       ...
       public string LabelText
       {
        ...
        public static readonly DependencyProperty SvgAttributeCurrentValueProperty =  
            DependencyProperty.Register("SvgAttributeCurrentValue", typeof(string), typeof(Svgonratechange),   
                new FrameworkPropertyMetadata("none", FrameworkPropertyMetadataOptions.AffectsRender,  
                    null));  
