...
namespace SvgComposition.ElementControls.BasicShapes
{
    ...
    /// </summary>
    public partial class SvgLine : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        public SvgLine()
        {
            ...
            BuildPermitedContent();
            SvgElementTypeName = "Unknown";
            ElementTitle.Text = SvgElementTypeName
            InitializeComponent();
            DataContext = this;
        }
...
#region configure 
     ...
     private void BuildPermitedContent()
        {
        ...
        private void BuildUnusedAttributeList()
        {
        ...
        public void Create(SvgElement parent)
        {
        ...
        public void Save(SvgElement ee)
        {
            foreach (SvgAttribute at in ee.SvgAttributes)
            {
