...
{
    /// <summary>
    /// Interaction logic for SvgTargetY.xaml
    /// </summary>
    public partial class SvgTargetY : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgTargetY), new FrameworkPropertyMetadata("none",
