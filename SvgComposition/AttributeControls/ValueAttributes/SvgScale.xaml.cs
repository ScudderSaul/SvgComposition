...
{
    /// <summary>
    /// Interaction logic for SvgScale.xaml
    /// </summary>
    public partial class SvgScale : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgScale), new FrameworkPropertyMetadata("none",
