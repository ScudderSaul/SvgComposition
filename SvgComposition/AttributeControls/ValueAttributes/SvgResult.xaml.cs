...
{
    /// <summary>
    /// Interaction logic for SvgResult.xaml
    /// </summary>
    public partial class SvgResult : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgResult), new FrameworkPropertyMetadata("none",
