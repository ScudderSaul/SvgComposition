...
{
    /// <summary>
    /// Interaction logic for SvgAStyle.xaml
    /// </summary>
    public partial class SvgAStyle : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgAStyle), new FrameworkPropertyMetadata("none",
