...
{
    /// <summary>
    /// Interaction logic for SvgExponent.xaml
    /// </summary>
    public partial class SvgExponent : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgExponent), new FrameworkPropertyMetadata("none",
