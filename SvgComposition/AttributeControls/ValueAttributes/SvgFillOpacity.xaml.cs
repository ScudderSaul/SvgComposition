...
{
    /// <summary>
    /// Interaction logic for SvgFillOpacity.xaml
    /// </summary>
    public partial class SvgFillOpacity : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgFillOpacity), new FrameworkPropertyMetadata("none",
