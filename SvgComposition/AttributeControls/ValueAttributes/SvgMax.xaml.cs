...
{
    /// <summary>
    /// Interaction logic for SvgMax.xaml
    /// </summary>
    public partial class SvgMax : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgMax), new FrameworkPropertyMetadata("none",
