...
{
    /// <summary>
    /// Interaction logic for SvgStrokeMiterlimit.xaml
    /// </summary>
    public partial class SvgStrokeMiterlimit : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {

        #region fields
        private string _svgAttributeOriginalValue = "4";
        private string _svgAttributeLocalValue = "4";
        private string _labelText;

       
        public SvgStrokeMiterlimit()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "stroke-miterlimit";
        }
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgStrokeMiterlimit), new FrameworkPropertyMetadata("none",
