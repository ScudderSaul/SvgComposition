...
{
    /// <summary>
    /// Interaction logic for SvgTabindex.xaml
    /// </summary>
    public partial class SvgTabindex : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgTabindex), new FrameworkPropertyMetadata("none",
