...
{
    /// <summary>
    /// Interaction logic for SvgSurfaceScale.xaml
    /// </summary>
    public partial class SvgSurfaceScale : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public SvgSurfaceScale()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "surfaceScale";
        }
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgSurfaceScale), new FrameworkPropertyMetadata("none",
