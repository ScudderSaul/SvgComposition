...
{
    /// <summary>
    /// Interaction logic for SvgTargetX.xaml
    /// </summary>
    public partial class SvgTargetX : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgTargetX), new FrameworkPropertyMetadata("none",
