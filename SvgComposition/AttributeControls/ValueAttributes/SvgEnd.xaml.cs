...
{
    /// <summary>
    /// Interaction logic for SvgEnd.xaml
    /// </summary>
    public partial class SvgEnd : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgEnd), new FrameworkPropertyMetadata("none",
