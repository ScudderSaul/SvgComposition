...
{
    /// <summary>
    /// Interaction logic for SvgFrom.xaml
    /// </summary>
    public partial class SvgFrom : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgFrom), new FrameworkPropertyMetadata("none",
