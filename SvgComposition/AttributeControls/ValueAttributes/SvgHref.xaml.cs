...
{
    /// <summary>
    /// Interaction logic for SvgHref.xaml
    /// </summary>
    public partial class SvgHref : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgHref), new FrameworkPropertyMetadata("none",
