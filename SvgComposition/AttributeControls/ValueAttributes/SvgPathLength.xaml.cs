...
{
    /// <summary>
    /// Interaction logic for SvgPathLength.xaml
    /// </summary>
    public partial class SvgPathLength : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public SvgPathLength()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "pathLength";
        }
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgPathLength), new FrameworkPropertyMetadata("none",
