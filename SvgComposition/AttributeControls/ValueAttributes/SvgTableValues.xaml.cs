...
{
    /// <summary>
    /// Interaction logic for SvgTableValues.xaml
    /// </summary>
    public partial class SvgTableValues : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        public SvgTableValues()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "tableValues";
        }
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgTableValues), new FrameworkPropertyMetadata("none",
