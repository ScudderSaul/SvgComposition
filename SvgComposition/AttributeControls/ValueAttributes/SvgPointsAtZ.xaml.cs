...
{
    /// <summary>
    /// Interaction logic for SvgPointsAtZ.xaml
    /// </summary>
    public partial class SvgPointsAtZ : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgPointsAtZ), new FrameworkPropertyMetadata("none",
