...
{
    /// <summary>
    /// Interaction logic for SvgNumOctaves.xaml
    /// </summary>
    public partial class SvgNumOctaves : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public SvgNumOctaves()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "numOctaves";
        }
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgNumOctaves), new FrameworkPropertyMetadata("none",
