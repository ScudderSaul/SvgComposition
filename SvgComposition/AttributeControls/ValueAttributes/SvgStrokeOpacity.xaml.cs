...
{
    /// <summary>
    /// Interaction logic for SvgStrokeOpacity.xaml
    /// </summary>
    public partial class SvgStrokeOpacity : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public SvgStrokeOpacity()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "stroke-opacity";
        }
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgStrokeOpacity), new FrameworkPropertyMetadata("none",
