...
{
    /// <summary>
    /// Interaction logic for SvgGradientTransform.xaml
    /// </summary>
    public partial class SvgGradientTransform : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public SvgGradientTransform()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "gradientTransform";
        }
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgGradientTransform), new FrameworkPropertyMetadata("none",
