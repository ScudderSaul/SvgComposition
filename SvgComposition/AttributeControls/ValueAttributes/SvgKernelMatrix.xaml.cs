...
{
    /// <summary>
    /// Interaction logic for SvgKernelMatrix.xaml
    /// </summary>
    public partial class SvgKernelMatrix : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public SvgKernelMatrix()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "kernelMatrix";
        }
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgKernelMatrix), new FrameworkPropertyMetadata("none",
