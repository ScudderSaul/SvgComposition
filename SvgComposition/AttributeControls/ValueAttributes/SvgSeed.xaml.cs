...
{
    /// <summary>
    /// Interaction logic for SvgSeed.xaml
    /// </summary>
    public partial class SvgSeed : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgSeed), new FrameworkPropertyMetadata("none",
