...
{
    /// <summary>
    /// Interaction logic for SvgRepeatDur.xaml
    /// </summary>
    public partial class SvgRepeatDur : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgRepeatDur), new FrameworkPropertyMetadata("none",
