...
{
    /// <summary>
    /// Interaction logic for SvgSpecularConstant.xaml
    /// </summary>
    public partial class SvgSpecularConstant : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public SvgSpecularConstant()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "specularConstant";
        }
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgSpecularConstant), new FrameworkPropertyMetadata("none",
