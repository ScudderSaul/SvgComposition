...
{
    /// <summary>
    /// Interaction logic for SvgPoints.xaml
    /// </summary>
    public partial class SvgPoints : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgPoints), new FrameworkPropertyMetadata("none",
