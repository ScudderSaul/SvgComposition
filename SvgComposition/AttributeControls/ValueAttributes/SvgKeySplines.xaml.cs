...
{
    /// <summary>
    /// Interaction logic for SvgKeySplines.xaml
    /// </summary>
    public partial class SvgKeySplines : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public SvgKeySplines()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "keySplines";
        }
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgKeySplines), new FrameworkPropertyMetadata("none",
