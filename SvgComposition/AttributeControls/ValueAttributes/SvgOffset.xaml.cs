...
{
    /// <summary>
    /// Interaction logic for SvgOffset.xaml
    /// </summary>
    public partial class SvgOffset : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgOffset), new FrameworkPropertyMetadata("none",
