...
{
    /// <summary>
    /// Interaction logic for SvgAttributeName.xaml
    /// </summary>
    public partial class SvgAttributeName : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgAttributeName), new FrameworkPropertyMetadata("none",
