...
{
    /// <summary>
    /// Interaction logic for SvgOpacity.xaml
    /// </summary>
    public partial class SvgOpacity : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgOpacity), new FrameworkPropertyMetadata("none",
