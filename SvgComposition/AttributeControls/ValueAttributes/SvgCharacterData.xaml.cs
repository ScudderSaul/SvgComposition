...
{
    /// <summary>
    /// Interaction logic for SvgCharacterData.xaml
    /// </summary>
    public partial class SvgCharacterData : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        public SvgCharacterData()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "characterData";
        }
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgCharacterData), new FrameworkPropertyMetadata("none",
