...
{
    /// <summary>
    /// Interaction logic for SvgSpecularExponent.xaml
    /// </summary>
    public partial class SvgSpecularExponent : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public SvgSpecularExponent()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "specularExponent";
        }
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgSpecularExponent), new FrameworkPropertyMetadata("none",
