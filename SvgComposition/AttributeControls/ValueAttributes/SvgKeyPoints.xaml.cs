...
{
    /// <summary>
    /// Interaction logic for SvgKeyPoints.xaml
    /// </summary>
    public partial class SvgKeyPoints : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgKeyPoints), new FrameworkPropertyMetadata("none",
