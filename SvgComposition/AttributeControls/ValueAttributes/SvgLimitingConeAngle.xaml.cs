...
{
    /// <summary>
    /// Interaction logic for SvgLimitingConeAngle.xaml
    /// </summary>
    public partial class SvgLimitingConeAngle : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public SvgLimitingConeAngle()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "limitingConeAngle";
        }
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgLimitingConeAngle), new FrameworkPropertyMetadata("none",
