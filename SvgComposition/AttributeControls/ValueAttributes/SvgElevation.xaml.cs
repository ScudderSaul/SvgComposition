...
{
    /// <summary>
    /// Interaction logic for SvgElevation.xaml
    /// </summary>
    public partial class SvgElevation : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgElevation), new FrameworkPropertyMetadata("none",
