...
{
    /// <summary>
    /// Interaction logic for SvgViewBox.xaml
    /// </summary>
    public partial class SvgViewBox : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgViewBox), new FrameworkPropertyMetadata("none",
        ...
        public void Load(SvgAttribute at)
        {
            ...
            try
            {
                string[] vs = SvgAttributeCurrentValue.Split(',');
                XBlock.Text = vs[0].Trim();
                YBlock.Text = vs[1].Trim();
                WBlock.Text = vs[2].Trim();
                HBlock.Text = vs[3].Trim();
            }
            catch (Exception e)
            {
                Console.WriteLine(e);
        ...
        {
            SvgAttributeCurrentValue =
                $"{XBlock.Text.Trim()}, {YBlock.Text.Trim()}, {WBlock.Text.Trim()}, {HBlock.Text.Trim()}";
