...
{
    /// <summary>
    /// Interaction logic for SvgBy.xaml
    /// </summary>
    public partial class SvgBy : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register("IsLabelText", typeof(string), typeof(SvgBy), 
        ...
        public static readonly DependencyProperty SvgAttributeCurrentValueProperty =
            DependencyProperty.Register(
                ...
                typeof(string),
                typeof(SvgBy), new FrameworkPropertyMetadata("none",
