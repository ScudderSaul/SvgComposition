...
{
    /// <summary>
    /// Interaction logic for SSvgOrient.xaml
    /// </summary>
    public partial class SvgOrient : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgOrient), new FrameworkPropertyMetadata("none",
