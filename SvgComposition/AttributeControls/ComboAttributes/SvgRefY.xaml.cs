...
{
    /// <summary>
    /// Interaction logic for SvgRefY.xaml
    /// </summary>
    public partial class SvgRefY : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgRefY), new FrameworkPropertyMetadata("none",
