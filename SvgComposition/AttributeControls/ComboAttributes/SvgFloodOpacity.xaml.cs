...
{
    /// <summary>
    /// Interaction logic for SvgFloodOpacity.xaml
    /// </summary>
    public partial class SvgFloodOpacity : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public SvgFloodOpacity()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "flood-opacity";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgFloodOpacity), new FrameworkPropertyMetadata("none",
