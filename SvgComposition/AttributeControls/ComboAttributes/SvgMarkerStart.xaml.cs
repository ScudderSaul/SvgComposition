...
{
    /// <summary>
    /// Interaction logic for SvgMarkerStart.xaml
    /// </summary>
    public partial class SvgMarkerStart : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public SvgMarkerStart()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "marker-start";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgMarkerStart), new FrameworkPropertyMetadata("none",
