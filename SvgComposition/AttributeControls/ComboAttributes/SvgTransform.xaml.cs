...
{
    /// <summary>
    /// Interaction logic for SvgTransform.xaml
    /// </summary>
    public partial class SvgTransform : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgTransform), new FrameworkPropertyMetadata("none",
        ...
        private void ComposeTransformList()
        {
            ...
            {
                translate = $"translate({coifs[0]} {coifs[1]})";
            }
