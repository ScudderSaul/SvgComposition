...
{
    /// <summary>
    /// Interaction logic for SvgFx.xaml
    /// </summary>
    public partial class SvgFx : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        #region fields
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgFx), new FrameworkPropertyMetadata("none",
