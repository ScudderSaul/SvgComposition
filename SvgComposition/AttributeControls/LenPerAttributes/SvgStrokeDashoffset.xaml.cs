...
{
    /// <summary>
    /// Interaction logic for SvgStrokeDashoffset.xaml
    /// </summary>
    public partial class SvgStrokeDashoffset : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        #region fields
        ...
        public SvgStrokeDashoffset()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "stroke-dashoffset";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgStrokeDashoffset), new FrameworkPropertyMetadata("none",
