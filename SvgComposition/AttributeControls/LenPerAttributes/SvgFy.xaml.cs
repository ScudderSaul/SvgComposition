...
{
    /// <summary>
    /// Interaction logic for SvgFy.xaml
    /// </summary>
    public partial class SvgFy : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        #region fields
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgFy), new FrameworkPropertyMetadata("none",
