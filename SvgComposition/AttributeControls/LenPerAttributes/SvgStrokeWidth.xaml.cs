...
namespace SvgComposition.AttributeControls.LenPerAttributes
{
    ...
    /// </summary>
    public partial class SvgStrokeWidth : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        #region fields
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgStrokeWidth), new FrameworkPropertyMetadata("none",
