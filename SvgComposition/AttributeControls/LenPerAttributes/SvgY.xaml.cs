...
{
    /// <summary>
    /// Interaction logic for SvgY.xaml
    /// </summary>
    public partial class SvgY : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        #region fields
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgY), new FrameworkPropertyMetadata("none",
