...
{
    /// <summary>
    /// Interaction logic for SvgFr.xaml
    /// </summary>
    public partial class SvgFr : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        #region fields
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgFr), new FrameworkPropertyMetadata("none",
