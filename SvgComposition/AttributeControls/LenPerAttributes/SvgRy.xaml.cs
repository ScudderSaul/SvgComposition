...
{
    /// <summary>
    /// Interaction logic for SvgRy.xaml
    /// </summary>
    public partial class SvgRy : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        #region fields
        private string _svgAttributeOriginalValue;
        private string _svgAttributeLocalValue;
        private string _labelText= "ry";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgRy), new FrameworkPropertyMetadata("none",
