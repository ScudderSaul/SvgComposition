...
{
    /// <summary>
    /// Interaction logic for SvgY2.xaml
    /// </summary>
    public partial class SvgY2 : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        #region fields
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgY2), new FrameworkPropertyMetadata("none",
