...
{
    /// <summary>
    /// Interaction logic for SvgMarkerWidth.xaml
    /// </summary>
    public partial class SvgMarkerWidth : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        #region fields
        ...
        public SvgMarkerWidth()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "markerWidth";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgMarkerWidth), new FrameworkPropertyMetadata("none",
