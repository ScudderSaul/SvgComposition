...
{
    /// <summary>
    /// Interaction logic for SvgRx.xaml
    /// </summary>
    public partial class SvgRx : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        #region fields
        private string _svgAttributeOriginalValue;
        private string _svgAttributeLocalValue;
        private string _labelText = "ellipse";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgRx), new FrameworkPropertyMetadata("none",
