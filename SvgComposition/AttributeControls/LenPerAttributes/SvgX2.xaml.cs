...
{
    /// <summary>
    /// Interaction logic for SvgX2.xaml
    /// </summary>
    public partial class SvgX2 : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        #region fields
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgX2), new FrameworkPropertyMetadata("none",
