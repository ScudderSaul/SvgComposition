...
namespace SvgComposition.AttributeControls.GlobalEventAttributes
{
     ...
     public partial class Svgondragexit : UserControl, ISvgAttributeControl, INotifyPropertyChanged
     {
  
     private string _labelText;
     private string _svgAttributeLocalValue = " ";
  
       public Svgondragexit()
       {
          InitializeComponent();
          DataContext = this;
          LabelText = "ondragexit";
       }
  
        public static readonly DependencyProperty IsLabelTextProperty =  
            DependencyProperty.Register("IsLabelText", typeof(string), typeof(Svgondragexit),   
       ...
       public string LabelText
       {
        ...
        public static readonly DependencyProperty SvgAttributeCurrentValueProperty =  
            DependencyProperty.Register("SvgAttributeCurrentValue", typeof(string), typeof(Svgondragexit),   
                new FrameworkPropertyMetadata("none", FrameworkPropertyMetadataOptions.AffectsRender,  
                    null));  
