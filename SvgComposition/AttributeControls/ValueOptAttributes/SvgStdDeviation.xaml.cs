...
{
    /// <summary>
    /// Interaction logic for SvgStdDeviation.xaml
    /// </summary>
    public partial class SvgStdDeviation : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public SvgStdDeviation()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "stdDeviation";
        }
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgStdDeviation), new FrameworkPropertyMetadata("none",
