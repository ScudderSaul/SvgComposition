...
{
    /// <summary>
    /// Interaction logic for SvgKernelUnitLength.xaml
    /// </summary>
    public partial class SvgKernelUnitLength : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public SvgKernelUnitLength()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "kernelUnitLength";
        }
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgKernelUnitLength), new FrameworkPropertyMetadata("none",
        ...
        public void Load(SvgAttribute at)
        {
            ...
            SvgAttributeOptionalValue = SvgOptionalBlock.Text = at.SecondaryValue;
        }
