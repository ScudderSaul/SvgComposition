...
{
    /// <summary>
    /// Interaction logic for SvgRadius.xaml
    /// </summary>
    public partial class SvgRadius : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgRadius), new FrameworkPropertyMetadata("none",
