...
{
    /// <summary>
    /// Interaction logic for SvgPatha.xaml
    /// </summary>
    public partial class SvgPatha : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgPatha), new FrameworkPropertyMetadata("none",
