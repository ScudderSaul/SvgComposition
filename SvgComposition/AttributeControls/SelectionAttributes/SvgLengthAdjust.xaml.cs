...
{
    /// <summary>
    /// Interaction logic for SvgLengthAdjust.xaml
    /// </summary>
    public partial class SvgLengthAdjust : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgLengthAdjust()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "lengthAdjust";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgLengthAdjust), new FrameworkPropertyMetadata("none",
