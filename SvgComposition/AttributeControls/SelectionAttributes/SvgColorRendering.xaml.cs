...
namespace SvgComposition.AttributeControls.SelectionAttributes
{
    ...
    /// </summary>
    public partial class SvgColorRendering : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        #region fields
     ...
     //   private string _lenperLocalUnit;
        ...
        public SvgColorRendering()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "color-rendering";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgColorRendering), new FrameworkPropertyMetadata("none",
