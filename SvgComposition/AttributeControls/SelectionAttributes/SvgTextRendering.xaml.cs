...
{
    /// <summary>
    /// Interaction logic for SvgTextRendering.xaml
    /// </summary>
    public partial class SvgTextRendering : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgTextRendering()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "text-rendering";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgTextRendering), new FrameworkPropertyMetadata("none",
