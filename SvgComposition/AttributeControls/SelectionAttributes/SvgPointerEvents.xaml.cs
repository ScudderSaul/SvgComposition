...
{
    /// <summary>
    /// Interaction logic for SSvgPointerEvents.xaml
    /// </summary>
    public partial class SvgPointerEvents : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgPointerEvents()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "pointer-events";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgPointerEvents), new FrameworkPropertyMetadata("none",
        ...
        public SvgAttribute Create(ref SvgElement ele)
        {
            ...
            at.AttributeValue = "visiblePainted";
