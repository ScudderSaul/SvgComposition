...
namespace SvgComposition.AttributeControls.SelectionAttributes
{
    ...
    /// </summary>
    public partial class SvgAdditive : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgAdditive), new FrameworkPropertyMetadata("none",
