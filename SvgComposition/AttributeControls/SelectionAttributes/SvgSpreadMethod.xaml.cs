...
{
    /// <summary>
    /// Interaction logic for SvgSpreadMethod.xaml
    /// </summary>
    public partial class SvgSpreadMethod : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgSpreadMethod()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "spreadMethod";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgSpreadMethod), new FrameworkPropertyMetadata("none",
