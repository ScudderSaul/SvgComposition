...
{
    /// <summary>
    /// Interaction logic for SvgAccumulate.xaml
    /// </summary>
    public partial class SvgAccumulate : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgAccumulate()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "accumulate";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgAccumulate), new FrameworkPropertyMetadata("none",
