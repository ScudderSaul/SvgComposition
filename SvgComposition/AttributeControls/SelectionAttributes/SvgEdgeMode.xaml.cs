...
namespace SvgComposition.AttributeControls.SelectionAttributes
{
    ...
    /// </summary>
    public partial class SvgEdgeMode : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgEdgeMode), new FrameworkPropertyMetadata("none",
        ...
        public SvgAttribute Create(ref SvgElement ele)
        {
            ...
            if (ele.ElementType == "feConvolveMatrix")
            {
                at.AttributeValue = "duplicate";
            }
            else
            {
