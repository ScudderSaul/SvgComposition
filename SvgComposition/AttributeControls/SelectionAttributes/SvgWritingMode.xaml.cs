...
{
    /// <summary>
    /// Interaction logic for SvgWritingMode.xaml
    /// </summary>
    public partial class SvgWritingMode  : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgWritingMode), new FrameworkPropertyMetadata("none",
        ...
        public SvgAttribute Create(ref SvgElement ele)
        {
            ...
            at.AttributeValue = "horizontal-tb";
