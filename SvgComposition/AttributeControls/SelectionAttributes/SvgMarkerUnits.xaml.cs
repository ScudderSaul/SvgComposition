...
{
    /// <summary>
    /// Interaction logic for SvgMarkerUnits.xaml
    /// </summary>
    public partial class SvgMarkerUnits : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgMarkerUnits()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "markerUnits";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgMarkerUnits), new FrameworkPropertyMetadata("none",
