...
{
    /// <summary>
    /// Interaction logic for SvgRestart.xaml
    /// </summary>
    public partial class SvgRestart : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgRestart), new FrameworkPropertyMetadata("none",
