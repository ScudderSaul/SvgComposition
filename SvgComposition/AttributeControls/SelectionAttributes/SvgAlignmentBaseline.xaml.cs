...
{
    /// <summary>
    /// Interaction logic for SvgAlignmentBaseline.xaml
    /// </summary>
    public partial class SvgAlignmentBaseline : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {

        private string _svgAttributeOriginalValue;
        private string _svgAttributeLocalValue;
        private string _labelText = "alignment-baseline";
    ...
    public SvgAlignmentBaseline()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "alignment-baseline";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgAlignmentBaseline), new FrameworkPropertyMetadata("none",
