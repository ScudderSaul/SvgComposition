...
{
    /// <summary>
    /// Interaction logic for SvgYChannelSelector.xaml
    /// </summary>
    public partial class SvgYChannelSelector : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgYChannelSelector()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "yChannelSelector";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgYChannelSelector), new FrameworkPropertyMetadata("none",
