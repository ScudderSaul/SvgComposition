...
{
    /// <summary>
    /// Interaction logic for SvgVectorEffect.xaml
    /// </summary>
    public partial class SvgVectorEffect : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        {
            "default", "non-scaling-stroke", "inherit",
        };

        #endregion
        #region ctor
        public SvgVectorEffect()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "vector-effect";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgVectorEffect), new FrameworkPropertyMetadata("none",
