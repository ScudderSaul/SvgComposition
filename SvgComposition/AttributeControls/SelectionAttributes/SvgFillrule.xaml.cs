...
{
    /// <summary>
    /// Interaction logic for SvgFillrule.xaml
    /// </summary>
    public partial class SvgFillrule : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgFillrule), new FrameworkPropertyMetadata("none",
