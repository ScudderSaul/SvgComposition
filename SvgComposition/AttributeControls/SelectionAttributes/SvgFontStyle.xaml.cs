...
{
    /// <summary>
    /// Interaction logic for SvgFontStyle.xaml
    /// </summary>
    public partial class SvgFontStyle : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgFontStyle), new FrameworkPropertyMetadata("none",
