...
{
    /// <summary>
    /// Interaction logic for SvgStrokeLinecap.xaml
    /// </summary>
    public partial class SvgStrokeLinecap : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgStrokeLinecap()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "stroke-linecap";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgStrokeLinecap), new FrameworkPropertyMetadata("none",
