...
namespace SvgComposition.AttributeControls.SelectionAttributes
{
    ...
    /// </summary>
    public partial class SvgCalcMode : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgCalcMode), new FrameworkPropertyMetadata("none",
