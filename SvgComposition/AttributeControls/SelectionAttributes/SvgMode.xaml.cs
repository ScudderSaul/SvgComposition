...
{
    /// <summary>
    /// Interaction logic for SvgMode.xaml
    /// </summary>
    public partial class SvgMode : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgMode), new FrameworkPropertyMetadata("none",
