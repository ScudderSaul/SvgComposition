...
{
    /// <summary>
    /// Interaction logic for SvgAttributeTypeA.xaml
    /// </summary>
    public partial class SvgAttributeTypeA : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgAttributeTypeA), new FrameworkPropertyMetadata("none",
