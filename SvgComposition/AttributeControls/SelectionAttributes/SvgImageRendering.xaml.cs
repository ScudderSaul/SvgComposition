...
{
    /// <summary>
    /// Interaction logic for SvgImageRendering.xaml
    /// </summary>
    public partial class SvgImageRendering : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgImageRendering()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "image-rendering";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgImageRendering), new FrameworkPropertyMetadata("none",
