...
{
    /// <summary>
    /// Interaction logic for SvgStitchTiles.xaml
    /// </summary>
    public partial class SvgStitchTiles : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgStitchTiles()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "stitchTiles";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgStitchTiles), new FrameworkPropertyMetadata("none",
