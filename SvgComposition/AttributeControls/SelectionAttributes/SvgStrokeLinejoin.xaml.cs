...
{
    /// <summary>
    /// Interaction logic for SvgStrokeLinejoin.xaml
    /// </summary>
    public partial class SvgStrokeLinejoin : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgStrokeLinejoin()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "stroke-linejoin";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgStrokeLinejoin), new FrameworkPropertyMetadata("none",
