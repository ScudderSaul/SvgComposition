...
{
    /// <summary>
    /// Interaction logic for SvgVisibility.xaml
    /// </summary>
    public partial class SvgVisibility : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgVisibility), new FrameworkPropertyMetadata("none",
