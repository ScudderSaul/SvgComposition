...
{
    /// <summary>
    /// Interaction logic for SvgExternalResourcesRequired.xaml
    /// </summary>
    public partial class SvgExternalResourcesRequired : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public SvgExternalResourcesRequired()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "externalResourcesRequired";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgExternalResourcesRequired), new FrameworkPropertyMetadata("none",
