...
namespace SvgComposition.AttributeControls.SelectionAttributes
{
    ...
    /// </summary>
    public partial class SvgDominantBaseline : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        public SvgDominantBaseline()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "dominant-baseline";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgDominantBaseline), new FrameworkPropertyMetadata("none",
