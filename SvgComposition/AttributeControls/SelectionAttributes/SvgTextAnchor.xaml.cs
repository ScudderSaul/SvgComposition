...
{
    /// <summary>
    /// Interaction logic for SvgTextAnchor.xaml
    /// </summary>
    public partial class SvgTextAnchor : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgTextAnchor()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "text-anchor";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgTextAnchor), new FrameworkPropertyMetadata("none",
