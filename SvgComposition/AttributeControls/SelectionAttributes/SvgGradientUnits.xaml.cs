...
{
    /// <summary>
    /// Interaction logic for SvgGradientUnits.xaml
    /// </summary>
    public partial class SvgGradientUnits : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgGradientUnits()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "gradientUnits";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgGradientUnits), new FrameworkPropertyMetadata("none",
