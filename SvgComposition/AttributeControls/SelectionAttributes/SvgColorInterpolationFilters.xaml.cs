...
namespace SvgComposition.AttributeControls.SelectionAttributes
{
    ...
    /// </summary>
    public partial class SvgColorInterpolationFilters : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        #region fields
        ...
        public SvgColorInterpolationFilters()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "color-interpolation-filters";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgColorInterpolationFilters), new FrameworkPropertyMetadata("none",
