...
{
    /// <summary>
    /// Interaction logic for SvgMaskContentUnits.xaml
    /// </summary>
    public partial class SvgMaskContentUnits : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgMaskContentUnits()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "maskContentUnits";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgMaskContentUnits), new FrameworkPropertyMetadata("none",
