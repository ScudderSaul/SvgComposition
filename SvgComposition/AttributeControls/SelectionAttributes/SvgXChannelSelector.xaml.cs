...
{
    /// <summary>
    /// Interaction logic for SvgXChannelSelector.xaml
    /// </summary>
    public partial class SvgXChannelSelector : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgXChannelSelector()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "xChannelSelector";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgXChannelSelector), new FrameworkPropertyMetadata("none",
