...
{
    /// <summary>
    /// Interaction logic for SvgPatternContentUnits.xaml
    /// </summary>
    public partial class SvgPatternContentUnits : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgPatternContentUnits()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "patternContentUnits";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgPatternContentUnits), new FrameworkPropertyMetadata("none",
        ...
        public SvgAttribute Create(ref SvgElement ele)
        {
            ...
            at.AttributeValue = "userSpaceOnUse";
