...
{
    /// <summary>
    /// Interaction logic for SvgPaintOrder.xaml
    /// </summary>
    public partial class SvgPaintOrder : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        {
            "normal", "fill stroke markers", "stroke fill markers", "markers, stroke fill", "fill markers stroke", "stroke markers fill", "markers fill stroke"
        };

        #endregion
        #region ctor
        public SvgPaintOrder()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "paint-order";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgPaintOrder), new FrameworkPropertyMetadata("none",
