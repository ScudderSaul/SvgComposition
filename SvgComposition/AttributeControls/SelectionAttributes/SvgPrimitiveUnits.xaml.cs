...
{
    /// <summary>
    /// Interaction logic for SvgPrimitiveUnits.xaml
    /// </summary>
    public partial class SvgPrimitiveUnits : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgPrimitiveUnits()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "primitiveUnits";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgPrimitiveUnits), new FrameworkPropertyMetadata("none",
