...
{
    /// <summary>
    /// Interaction logic for SvgShapeRendering.xaml
    /// </summary>
    public partial class SvgShapeRendering : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgShapeRendering()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "shape-rendering";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgShapeRendering), new FrameworkPropertyMetadata("none",
