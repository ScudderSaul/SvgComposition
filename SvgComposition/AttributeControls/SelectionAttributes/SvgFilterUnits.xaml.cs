...
{
    /// <summary>
    /// Interaction logic for SvgFilterUnits.xaml
    /// </summary>
    public partial class SvgFilterUnits : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        #endregion
        #region ctor
        public SvgFilterUnits()
        {
            InitializeComponent();
            DataContext = this;
            LabelText = "filterUnits";
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgFilterUnits), new FrameworkPropertyMetadata("none",
