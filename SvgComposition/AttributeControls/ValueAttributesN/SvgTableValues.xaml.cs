...
{
    /// <summary>
    /// Interaction logic for SvgTo.xaml
    /// </summary>
    public partial class SvgTo : UserControl, ISvgAttributeControl, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsLabelTextProperty =
            DependencyProperty.Register(
                "IsLabelText",
                typeof(string),
                typeof(SvgTo), new FrameworkPropertyMetadata("none",
