...
{
    /// <summary>
    /// Interaction logic for SvgfeDisplacementMap.xaml
    /// </summary>
    public partial class SvgfeDisplacementMap : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        public SvgfeDisplacementMap()
        {
            this.Visibility = Visibility.Visible;
            this.BorderBrush = new SolidColorBrush(Colors.Black);
            this.BorderThickness = new Thickness(1.0);
            BuildPermittedContent();
            SvgElementTypeName = "feDisplacementMap";
