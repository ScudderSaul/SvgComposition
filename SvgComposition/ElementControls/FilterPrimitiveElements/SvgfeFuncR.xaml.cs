...
{
    /// <summary>
    /// Interaction logic for SvgfeFuncR.xaml
    /// </summary>
    public partial class SvgfeFuncR : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
...
#region configure 
     ...
     public void BuildPermittedContent()
        ...
        public void BuildUnusedAttributeList()
        {
            ...
            foreach (string st in SvgAttributeCreator.TransferFunctionAttributes)
            {
                if (_attributeChoices.Contains(st) == false)
                {
                    _attributeChoices.Add(st);
