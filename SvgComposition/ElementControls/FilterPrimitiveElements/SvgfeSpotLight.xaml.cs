...
{
    /// <summary>
    /// Interaction logic for SvgfeSpotLight.xaml
    /// </summary>
    public partial class SvgfeSpotLight : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "id", "specularExponent","pointsAtX", "pointsAtY", "pointsAtZ",
        };
        ...
        public SvgfeSpotLight()
        {
            ...
            SvgElementTypeName = "feSpotLight";
