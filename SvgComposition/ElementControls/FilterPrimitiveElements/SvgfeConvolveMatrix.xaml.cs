...
{
    /// <summary>
    /// Interaction logic for SvgfeConvolveMatrix.xaml
    /// </summary>
    public partial class SvgfeConvolveMatrix : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "id",  "divisor", "bias", "targetX", "targetY", "edgeMode", "kernelUnitLength", "preserveAlpha", "class", "style", "result"
        };

        private List<string> _startWith = new List<string>
        {
            "in", "order", "kernelMatrix", 
        };
        ...
        public SvgfeConvolveMatrix()
        {
            ...
            SvgElementTypeName = "feConvolveMatrix";
