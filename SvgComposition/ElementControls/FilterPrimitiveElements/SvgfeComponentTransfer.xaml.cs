...
{
    /// <summary>
    /// Interaction logic for SvgfeComponentTransfer.xaml
    /// </summary>
    public partial class SvgfeComponentTransfer : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        public SvgfeComponentTransfer()
        {
            ...
            SvgElementTypeName = "feComponentTransfer";
            InitializeComponent();
            DataContext = this;
        }
