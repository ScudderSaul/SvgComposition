...
{
    /// <summary>
    /// Interaction logic for SvgfeComposite.xaml
    /// </summary>
    public partial class SvgfeComposite : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        public SvgfeComposite()
        {
            ...
            SvgElementTypeName = "feComposite";
      //      TitleTextBlock.Text = SvgElementTypeName;
            InitializeComponent();
            DataContext = this;
        }
