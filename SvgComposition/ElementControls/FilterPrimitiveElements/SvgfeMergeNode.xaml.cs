...
{
    /// <summary>
    /// Interaction logic for SvgfeMergeNode.xaml
    /// </summary>
    public partial class SvgfeMergeNode : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        public SvgfeMergeNode()
        {
            this.Visibility = Visibility.Visible;
            this.BorderBrush = new SolidColorBrush(Colors.Black);
            this.BorderThickness = new Thickness(1.0);
            BuildPermittedContent();
            SvgElementTypeName = "feMergeNode";
