...
{
    /// <summary>
    /// Interaction logic for SvgfeDropShadow.xaml
    /// </summary>
    public partial class SvgfeDropShadow : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
             "in", "stdDeviation", "dx", "dy",
        };

        #endregion

        public SvgfeDropShadow()
        {
            this.Visibility = Visibility.Visible;
            this.BorderBrush = new SolidColorBrush(Colors.Black);
            this.BorderThickness = new Thickness(1.0);
            BuildPermittedContent();
            SvgElementTypeName = "feDropShadow";
