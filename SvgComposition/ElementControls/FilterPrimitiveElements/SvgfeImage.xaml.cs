...
{
    /// <summary>
    /// Interaction logic for SvgfeImage.xaml
    /// </summary>
    public partial class SvgfeImage : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "id",  "class", "style", "preserveAspectRatio", "externalResourcesRequired"
        };
