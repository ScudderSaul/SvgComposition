...
namespace SvgComposition.ElementControls.OtherElements
{
    /// <summary>
    /// Interaction logic for SvgFilter.xaml
    /// </summary>
    public partial class SvgFilter : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "x", "y", "width", "height",  "href", "class", "style", "externalResourcesRequired", "filterRes", "filterUnits", "primitiveUnits",
        };
     ...
     public void BuildPermittedContent()
        {
            ...
            foreach (string gg in SvgElementCreator.FilterPrimitiveElements)
            {
                if (_permitedChildElements.Contains(gg) == false)
                {
                    _permitedChildElements.Add(gg);
