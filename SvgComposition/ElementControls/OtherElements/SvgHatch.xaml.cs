...
{
    /// <summary>
    /// Interaction logic for SvgHatch.xaml
    /// </summary>
    public partial class SvgHatch : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "id",  "hatchContentUnits", "transform", "href", "tabindex", "class", "style"
        };

        private List<string> _startWith = new List<string>
        {
            "x", "y", "pitch", "rotate", "hatchUnits",
        };
