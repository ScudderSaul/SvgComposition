...
namespace SvgComposition.ElementControls.TextContentElements
{
    /// <summary>
    /// Interaction logic for SvgText.xaml
    /// </summary>
    public partial class SvgText : UserControl, ISvgElementControl, INotifyPropertyChanged
    {

        #region fields
        private SvgElement _svgElement;
        private string _svgElementName = string.Empty;
        ...
        {
            "id", "class", "style", "textLength", "lengthAdjust", "dx", "dy",
        };
     ...
     public void BuildPermittedContent()
        {
            ...
            foreach (string gg in SvgElementCreator.TextContentChildElements)
            {
                if (_permitedChildElements.Contains(gg) == false)
                {
                    _permitedChildElements.Add(gg);
