...
{
    /// <summary>
    /// Interaction logic for SvgTspan.xaml
    /// </summary>
    public partial class SvgTspan : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "id", "class", "style", "dx", "dy", "rotate", "lengthAdjust", "textLength"
        };
