...
{
    /// <summary>
    /// Interaction logic for SvgTextPath.xaml
    /// </summary>
    public partial class SvgTextPath : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "id", "class", "style", "lengthAdjust", "method", "side", "spacing", "startOffset", "textLength"
        };
