...
namespace SvgComposition.ElementControls.GradientElements
{
    /// <summary>
    /// Interaction logic for SvgRadialGradient.xaml
    /// </summary>
    public partial class SvgRadialGradient : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "id", "class", "style", "gradientUnits", "gradientTransform", "spreadMethod", "href",
        };
        ...
        public SvgRadialGradient()
        {
            ...
            SvgElementTypeName = "radialGradient";
...
#region configure 
     ...
     public void BuildPermittedContent()
        ...
        public void BuildUnusedAttributeList()
        {
            ...
            foreach (string st in SvgAttributeCreator.DocumentElementEventAttributes)
            {
                if (_attributeChoices.Contains(st) == false)
                {
                    _attributeChoices.Add(st);
