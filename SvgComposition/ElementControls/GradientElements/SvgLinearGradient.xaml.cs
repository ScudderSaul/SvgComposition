...
{
    /// <summary>
    /// Interaction logic for SvgLinearGradient.xaml
    /// </summary>
    public partial class SvgLinearGradient : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "id", "href", "class", "style", "gradientUnits", "gradientTransform", "spreadMethod",
        };
        ...
        public SvgLinearGradient()
        {
            ...
            SvgElementTypeName = "linearGradient";
