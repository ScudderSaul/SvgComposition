...
namespace SvgComposition.ElementControls.DescriptiveElements
{
    /// <summary>
    /// Interaction logic for SvgTitle.xaml
    /// </summary>
    public partial class SvgTitle : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
