...
namespace SvgComposition.ElementControls.BasicShapes
{
    ...
    /// </summary>
    public partial class SvgRect : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "id", "x", "y", "width", "height",  "stroke", "stroke-opacity", "stroke-width", "fill", "fill-opacity",
        };
        ...
        private void RemoveAttributeButton_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            if (result == true && chch.ChosenAttribute != null)
            {
