...
{
    /// <summary>
    /// Interaction logic for SvgCircle.xaml
    /// </summary>
    public partial class SvgCircle : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "cx", "cy", "r", "stroke",
            "stroke-opacity", "stroke-width", "fill",
            "fill-opacity",
        };
