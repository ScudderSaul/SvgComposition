...
{
    /// <summary>
    /// Interaction logic for SvgSet.xaml
    /// </summary>
    public partial class SvgSet : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "id", "class", "style", "externalResourcesRequired"
        };
...
#region configure 
     ...
     public void BuildPermittedContent()
        ...
        public void BuildUnusedAttributeList()
        {
            ...
            foreach (string st in SvgAttributeCreator.AnimationAttributeTargetAttributes)
            {
                if (_attributeChoices.Contains(st) == false)
                {
                    _attributeChoices.Add(st);
