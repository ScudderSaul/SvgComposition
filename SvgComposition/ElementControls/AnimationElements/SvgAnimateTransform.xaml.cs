...
{
    /// <summary>
    /// Interaction logic for SvgAnimateTransform.xaml
    /// </summary>
    public partial class SvgAnimateTransform : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "id", "tabindex", "style", "attributeType", "attributeName",
            "begin", "dur", "end", "min,", "max", "restart", "repeatCount", "repeatDur",
            "calcMode", "values", "keyTimes", "keySplines", "from", "to", "by",
            "autoReverse", "accelerate", "decelerate", "additive,", "accumulate"
        ...
        public SvgAnimateTransform()
        {
            ...
            SvgElementTypeName = "animateTransform";
            InitializeComponent();
            DataContext = this;
        }
