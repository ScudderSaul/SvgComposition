...
{
    /// <summary>
    /// Interaction logic for SvgAnimate.xaml
    /// </summary>
    public partial class SvgAnimate : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "id", "tabindex", "style", "fill",
            "begin", "dur", "end", "min", "max", "restart", "repeatCount", "repeatDur", 
            "calcMode", "values", "keyTimes", "keySplines", "from", "to", "by",
            "autoReverse", "accelerate", "decelerate", "additive,", "accumulate", "onbegin"
        ...
        public void Create(ref SvgElement parent)
        {
            ...
            foreach (string st in _startWith)
            {
                ...
                {
                    MessageBox.Show($"No ISvgAttributeControl found for {st}");
                }
                else
                {
