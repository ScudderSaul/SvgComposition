...
{
    /// <summary>
    /// Interaction logic for SvgMarker.xaml
    /// </summary>
    public partial class SvgMarker : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "id", "class", "style", "preserveAspectRatio", "markerUnits",
        };

        private List<string> _startWith = new List<string>
        {
            "markerHeight",  "markerWidth", "orient", "refX", "refY", "viewBox"
        };
