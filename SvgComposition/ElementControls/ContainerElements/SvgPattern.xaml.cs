...
{
    /// <summary>
    /// Interaction logic for SvgPattern.xaml
    /// </summary>
    public partial class SvgPattern : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "id", "patternTransform", "patternUnits", "preserveAspectRatio", "patternContentUnits", "class", "style",
        };

        private List<string> _startWith = new List<string>
        {
            "height", "width","href", "x", "y",   "viewBox", 
        };
