...
{
    /// <summary>
    /// Interaction logic for SvgMask.xaml
    /// </summary>
    public partial class SvgMask : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "class", "style", "maskContentUnits", "maskUnits"
        };
     ...
     public void BuildPermittedContent()
        ...
        public void AddAttribute(string name)
        {
            ...
            else
            {
                ...
                SvgAttribute ee = ic.Create(ref _svgElement);
            }
