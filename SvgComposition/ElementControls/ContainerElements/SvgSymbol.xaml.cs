...
{
    /// <summary>
    /// Interaction logic for SvgSymbol.xaml
    /// </summary>
    public partial class SvgSymbol : UserControl, ISvgElementControl, INotifyPropertyChanged
    {
        ...
        {
            "id", "viewBox", "preserveAspectRatio",  "refX", "refY", "class", "style",
        };
